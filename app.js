...
function showResults() {
    ...
    scoreText.textContent = `Your Score: ${score} / ${questions.length} (${scorePercent}%)`;

    if (scorePercent >= 80) {
        feedbackMessage.textContent = "🎉 Excellent! You're a Quiz Master!";
    } else if (scorePercent >= 50) {
        feedbackMessage.textContent = "👍 Good job! Keep practicing.";
    } else {
        feedbackMessage.textContent = "📚 Don't worry! Try again and you'll improve!";
    }

    document.querySelector('.quiz-area').classList.add('hidden');
